...
public class Player : MonoBehaviour {
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown("joystick button 10") || Input.GetKeyDown(KeyCode.LeftShift))
        {
            speed = speed + 1500;
        }
        else
        {
            if (Input.GetKeyUp("joystick button 10") || Input.GetKeyUp(KeyCode.LeftShift))
            {
                speed = speed - 1500;
            }
        }
        ...
        if (Input.GetKeyDown("joystick button 1") && !isFalling && underwater.isUnderwater == false)
        {
        ...
        else
        {
            ...
            if (Input.GetKeyUp("joystick button 1") && !isFalling && underwater.isUnderwater == true)
            {
                rb.AddForce(Vector3.up * jumpHeight, ForceMode.Impulse);
                isFalling = true;
            ...
            if (Input.GetKeyDown("joystick button 1") && !isFalling && underwater1.isUnderwater == false)
            {
            ...
            {
                // If X is pressed on the controller and is underwater, then the underwater jump sound will play.
                if (Input.GetKeyUp("joystick button 1") && !isFalling && underwater1.isUnderwater == true)
                {
                    rb.AddForce(Vector3.up * jumpHeight, ForceMode.Impulse);
                    isFalling = true;
                    underwater.isUnderwater = true;
